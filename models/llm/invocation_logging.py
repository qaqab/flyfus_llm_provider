...
class InvocationLog:
    ...
    def flush(self) -> None:
        ...
        event = {
            ...
            "model": self.model,
            "configured_model": self.request.get("configured_model") or self.model,
            "routed_model": self.request.get("routed_model") or self.model,
            "model_route_applied": bool(self.request.get("model_route_applied")),
            "stream": self.stream,
            "user": self.user,
            "user_id": str(self.request.get("user_id") or ""),
